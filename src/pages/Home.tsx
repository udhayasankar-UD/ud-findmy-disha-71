              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button
                    size="lg"
                    asChild
                    className="group bg-primary hover:bg-primary-dark text-lg px-8 transition-colors duration-300 ease-in-out"
                  >
                    <Link to="/login">
                      Login
                      <ArrowRight className="ml-2 w-5 h-5 transition-transform duration-300 ease-in-out group-hover:translate-x-1" />
                    </Link>
                  </Button>
                  <Button
                    size="lg"
                    variant="outline"
                    asChild
                    className="border-white text-orange-500 hover:bg-white/20 hover:text-orange-500 text-lg px-8 transition-colors duration-200"
